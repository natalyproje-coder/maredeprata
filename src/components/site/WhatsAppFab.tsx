...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="fixed right-4 bottom-22 z-40 flex h-11 sm:h-12 items-center gap-2 border border-border bg-card/90 px-3 sm:px-4 shadow-lux backdrop-blur transition-colors hover:bg-secondary md:bottom-6"
    >
